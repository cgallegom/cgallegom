...
**Current interests:**
- Real-world evidence (RWE) in policy evaluation
...
- **Data Visualization**: Making complex health data accessible

**Selected Publications:** [Google Scholar](https://scholar.google.com/citations?user=YourID)
